...
if not lines:
    ...
    for i in zhongxin_old:
        if i in idea:
            ...
            elif i == "PP"  or i == "玻璃" or i == "沥青" or i == "锡":
...
for i in guotai_old:
    if i in idea:
        if i == "PTA" or i == "PP" or i =="不锈钢" or i == "螺纹" or i == "热卷" or i == "玻璃" or i == "沥青"\
                or i == "塑料" or i == "PP" or i == "锡" or i == "白糖":
...
for i in wukuang_old:
    if i in idea:
        if i == "螺纹" or i == "热卷" or i == '橡胶' or i == "锡":
            wukuang_old[i] = idea[i] + " ！！五矿很准！！ " + wukuang_old[i]
        elif i == "棕榈油" or i == "豆油" or i == "菜油" or i == "豆粕" or i == "菜粕":
...
with open('国信.txt') as f:
    lines = f.readlines()
idea = {}
items = ["股指","国债","贵金属","铜铝","玻璃","锌镍","锌","螺纹钢","锰硅：","硅铁：","铁合金","焦炭焦煤","镍","豆类","油脂","白糖","棉花","玉米","生猪","花生","苹果","PTA","聚烯烃","原油","橡胶","燃料油","沥青","甲醇","铁矿石","动力煤"]
next = False
prev_item = ""
for l in lines:
    stripped = l.strip().strip('\n').strip('【').strip('】')
...
items = ["国债日报","股指","螺纹","热卷","铁矿","焦煤","焦炭","锰硅","尿素","硅锰","硅铁","动力煤","纯碱","玻璃","白糖","棉花","苹果","红枣","油料","油脂","原油","油脂油料","甲醇","燃料油","PVC","聚酯","沥青",
         "PTA","MEG","PF","LPG","纸浆","橡胶","铜","铝","锌","镍不锈钢","锡","贵金属","聚烯烃","螺纹钢","铁矿石","郑棉","豆粕","生猪","MA","SC","RU","EB","乙二醇","苯乙烯","PTA&PF","硅锰观点"]
next = False
prev_item = ""
for l in lines:
    stripped = l.strip()
...
for i in nanhua_old:
    if i in idea:
        if i == "燃油" or i == "PP" or i == "玻璃" or i == "焦煤" or i == "塑料" or i == "PP" or i == '橡胶':
            nanhua_old[i] = idea[i] + " ！！南华很准！！ " + nanhua_old[i]
        elif i == "棕榈油" or i == "豆油" or i == "菜油":
...
with open('东兴.txt') as f:
    lines = f.readlines()
idea = {}
items = ["期指","期债","动力煤","铜","PTA","TA","PVC","天然橡胶","生猪","玉米","橡胶","MA","煤焦","油脂"]
next = False
prev_item = ""
for l in lines:
    stripped = l.strip()
...
for i in hongye_old:
    if i in idea:
        ...
        elif i == "PTA" or i == "螺纹" or i == "热卷" or i == "塑料" or i == "PP":
...
for i in [zhongxin_old, guotai_old, guotou_old, guangda_old, zhongqi_old, wukuang_old, beite_old,
          ...
          hongye_old, dongwu_old, hualian_old, zhongzhou_old, yide_old]:
    for j in i:
...
for i in [guotai_idea, anxin_idea, guangda_idea, citrix_idea,zhongqi_idea, wukuang_idea, beite_idea,
          ...
          hundunneng_idea, hundunagri_idea, hongye_idea, dongwu_idea, hualian_idea, zhongzhou_idea, yide_idea]:
    for j in i:
        if j.strip() == "":
            abc = 1
        if j in combined:
...
with open('详细观点分公司.txt', 'w') as f:
    for i in [zhongxin_old, guotai_old, guotou_old, guangda_old, zhongqi_old, wukuang_old,
              ...
              hundunneng_old, hundunagri_old, hongye_old, dongwu_old, hualian_old, zhongzhou_old, yide_old]:
        new = True
        for j in i:
            if new:
                f.write(i[j].split(" ")[1] + "\n\n")
