...
with open('南华.txt', encoding='gbk') as f:
    lines = f.readlines()
idea = {}
items = ["国债日报","股指","黄金","螺纹","热卷","碳酸锂","铁矿","焦煤","焦炭","锰硅","尿素","硅锰","硅铁","动力煤","纯碱","玻璃","白糖","棉花","苹果","红枣","油料","油脂","原油","油脂油料","甲醇","燃料油","PVC","聚酯","沥青",
         "PTA","MEG","PF","PX","TA","废钢","EG","LPG","鸡蛋","镍&不锈钢","焦煤焦炭","铝&氧化铝","RU2405","纸浆","橡胶","玉米&淀粉","工业硅","铜","铝","锌","镍不锈钢","锡","豆一","贵金属","聚烯烃","螺纹钢","铁矿石","郑棉","豆粕","生猪","MA","SC","RU","EB","乙二醇","苯乙烯","PTA&PF","硅锰观点"]
next = False
prev_item = ""
for l in lines:
    stripped = l.strip()
...
items = ["螺卷","铁矿","双焦","双硅","原油","沥青","LPG","甲醇","PVC","天然橡胶","PX","铝/氧化铝","镍/不锈钢",
         ...
         "生猪","苹果","红枣","花生","MEG","铜","铝","PX","锌","铅","工业硅","棉花棉纱","玻璃纯碱","沪铝/氧化铝"]
...
items = ["期指","期债","黄金/白银","贵金属","螺纹/热卷","螺纹/热卷(RB2310/HC2310)","螺纹/热卷(RB2305/HC2305)","煤焦","塑料/PP","塑料/pp","硅锰","硅铁","动力煤","铁矿石","沪铝","沪镍","沪铜","沪锌",
         "沪铅","苹果","红枣","鸡蛋","碳酸锂","生猪","燃料油","锌","白糖","EC","硅","甲醇","PVC","PTA","MEG","集运指数","尿素","纯碱","玻璃","塑料/PP","苯乙烯","聚酯","原油","工业硅","沪锡","锰硅/硅铁"]
...
order = ["","小结：","金融","股指","股指期权","国债","黑色金属","螺纹钢","纯碱玻璃","铁矿","焦煤","焦炭","螺纹","热卷","硅铁","锰硅","工业硅","有色金属","碳酸锂","氧化铝","铝","铜","锌","锡","镍","不锈钢","铅","贵金属","黄金","白银","能源化工",
 ...
 "苹果","花生","红枣","生猪","集运","集运指数（欧线）","PPX&PTA&MEG","硅：市场分歧，弱势盘整"]
