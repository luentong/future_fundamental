low = ["偏弱", "下滑", "弱势", "下行", "走弱", "做空", "偏空", "下跌", "试空", "回落", "短空", "空单操作", "偏弱","向下压力较大","空头思路","抛空为主","反弹抛空",
       ...
       "高抛","空单继续持有","回调整理","空单持有","鹰派信号","压制铜价","持续偏弱","关注做空机会","逢高空"]
...
fluc = ["观望", "不宜", "离场", "上行承压", "上行乏力", "震荡对待", "先扬后抑", "短期反弹,趋势偏弱", "下行驱动逐渐放缓",
        ...
        "维持震荡走势","短空止盈","短多止盈","上行动力不足","仍难打破震荡形态","等待企稳","高位调整压力","偏涨看待","高抛低吸"]
...
def simplify_sent(c):
    ...
    for c in cut_list:
        ...
        if "震荡对待" in c or "上行空间受限" in c or "下行空间受限" in c or "波动风险加大" in c \
                ...
                or "仍难打破震荡形态" in c or "等待企稳" in c or "高抛低吸" in c:
            return "0"
        ...
        if "反弹难持续" in c or "布局空单" in c:
            return "-1"
        if "近弱远强" in c or "顶部价格已现" in c or "顶部已现" in c or "反弹后抛空" in c or "逢高抛空" in c or '空单轻仓持有' in c or "短线空单参与" in c:
            return "-0.8"
        if "下行驱动逐渐放缓" in c or "弱平衡" in c or "不过于追空" in c or "空单谨慎" in c or "谨慎承压" in c or "有回调可能" in c or "压制期价上行" in c:
            return '-0.5'
        if "正套" in c or "多单谨慎持有" in c or "低点支撑" in c or "涨势趋缓" in c or "空单止盈" in c or "仍较抗跌" in c or "反弹幅度有限" in c or "短多长空" in \
                ...
                or "comex金涨" in c or "多EG" in c or "谨慎追涨" in c or "回调幅度有限" in c or "不宜追多" in c or "短线炒作" in c or "支撑尚存" in c or "上方空间有限" in c:
            return '0.5'
        if "多头谨慎持有" in c or "偏涨看待" in c:
                return '0.7'
        if "反套" in c or "空单谨慎持有" in c or "多单止盈" in c or "不宜过分看跌" in c or "限制价格回升" in c or "短空长多" in c or "谨慎悲观" in c \
