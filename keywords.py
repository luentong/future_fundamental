...
to_continue = ["才可能企稳回升","才可能企稳","议做多裂解价差","加工差承压","开工下滑","难提振","FU偏强","油价压力","回调风险逐步降低","积极性回升","下跌主要来自",
               ...
               "极性回升","不锈钢价格的上涨","等待利多的基本面","正套逐步止盈","做多钢厂利润","结合油价下跌",
...
zero = ["震荡对待","上行空间受限","下行空间受限","波动风险加大","震荡为主","高位震荡","盘面震荡","反弹空间有限","反弹幅度已经较高","多TA空EG",
                ...
                "上行阻力依然较大","维持区间震荡", "交割因素扰动","不建议空单操作","不建议多单操作","继续观望","反弹不可延续","震荡筑底","PX继续强势",
...
point_5 = ["多单谨慎持有","低点支撑","涨势趋缓","仍较抗跌","反弹幅度有限","短多长空","下游补库积极","冲高一波后再回落",
           "短期获支撑","回落偏多","中枢上移","利润有望继续修复","短线低吸","回调企稳逢低做多","中期多头配置",
...
point_3 = ["买近抛远","短空止盈","有支撑","下跌之后反弹","回调空间有限","反弹高度将一般","仍存支撑","上涨持续性仍待观察","有反弹的概率","价格仍存支撑","下跌动能不足","短时超跌反弹","支撑仍在",
            "空单止盈","不宜过度追高","震荡止跌","支撑依然在","逢低多但不要追多","不必过度悲观","不轻言单边做空","继续下跌的空间有限","限制价格回落","等待布局多单机会","反弹将面临","估值支撑"]
point_neg_8 = ["近弱远强","顶部价格已现","顶部已现","反弹后抛空","逢高抛空","空单轻仓持有","维持下跌态势",
                "短线空单参与","维持偏空思路","逢高轻仓试空","卖出套保头寸","震荡偏强对待"]
point_neg_7 = ["回落","存在较强的上行压力","回调","短期压力加剧","偏弱震荡","逢高试空","弱势震荡","跌势为主","维持下跌态势","择机布空",
               "继续探底","高空","较强上行压力","空单设好止盈","价格偏弱运行","价格仍有一定下行空间","宽幅震荡偏弱"]
point_neg_5 = ["下行驱动逐渐放缓","弱平衡","不过于追空","空单谨慎","谨慎承压","有回调可能","压制期价上行","价格承压","弱于黄金",
