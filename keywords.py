low = ["反弹难持续","布局空单","空头持有","偏弱震荡","偏弱", "下滑", "弱势", "下行", "走弱", "做空", "偏空", "下跌", "试空", "短空", "空单操作", "偏弱","向下压力较大","空头思路","抛空为主","反弹抛空",
       ...
       "高抛","空单继续持有","偏弱运行","回调整理","空单持有","鹰派信号","压制铜价","持续偏弱","关注做空机会","逢高空","震荡趋弱"]
...
zero = ["震荡对待","上行空间受限","下行空间受限","波动风险加大","震荡为主","高位震荡","盘面震荡","反弹空间有限","反弹幅度已经较高",
                ...
                "反弹难持续","不建议单边追空", "上行空间受限", "建议观望","暂无利好","近月不追空","短期建议观望","等待行情","区间交易为主","不宜追空下跌近尾声","观望为主","理性等待","区间策略","底部震荡","震荡区间","上行空间或受限"]
...
point_5 = ["多单谨慎持有","低点支撑","涨势趋缓","仍较抗跌","反弹幅度有限","短多长空","下游补库积极","冲高一波后再回落","短期获支撑","回落偏多","中枢上移","利润有望继续修复",
                ...
                "易涨难跌","仍偏强","多单轻仓","谨慎追多","形成托底","多单少量参与","支撑盘面","多单滚动操作","一定提振作用","贴水收窄","远月驱动渐显","轻仓试多",
...
point_neg_7 = ["回落","存在较强的上行压力","回调","短期压力加剧","偏弱震荡","逢高试空","弱势震荡","跌势为主","维持下跌态势","继续探底","高空"]
point_neg_5 = ["下行驱动逐渐放缓","弱平衡","不过于追空","空单谨慎","谨慎承压","有回调可能","压制期价上行","价格承压",
                "中期看空","等待机会做空","继续回调","偏空对待","长线偏空","后期仍有压力","反弹抛空","面临调整",
                "上行空间也较为有限","轻仓做空","重心下移","下调风险","难有趋势性上涨行情","持续性压制","重心或有下移",
                "空单谨慎持有","不宜过分看跌","限制价格回升","短空长多","谨慎悲观","贴水继续走弱","看空也会偏短暂","轻仓做空远月合约"]
point_neg_3 = ["短多止盈","高位调整压力","上行压力加大","上行动能不足","难有向上驱动","价格稳定偏弱","不容乐观",
