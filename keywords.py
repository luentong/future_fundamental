...
zero = ["震荡对待","上行空间受限","下行空间受限","波动风险加大","震荡为主","高位震荡","盘面震荡","反弹空间有限","反弹幅度已经较高",
                ...
                "区间操作","持续上涨动能不足","谨防冲高回落","上行承压", "上行乏力", "震荡对待", "先扬后抑","下行驱动逐渐放缓",
                "反弹难持续","单边观望为主","等待试多机会","等待低多机会","合约震荡","主力合约震荡","轻仓参与震荡","不建议单边追空","短期盘面呈震荡", "上行空间受限", "建议观望","暂无利好","近月不追空","短期建议观望","等待行情","区间交易为主","不宜追空下跌近尾声","观望为主","理性等待","区间策略","底部震荡","震荡区间","上行空间或受限"]
