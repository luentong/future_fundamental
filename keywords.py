...
to_continue = ["才可能企稳回升","中长线偏空","才可能企稳","开工率回升","基差快速回落","偏多9","长期维持逢高沽空","中期或震荡偏弱","做多裂解价差","加工差承压","需求超预期回升","果价格大幅下滑","反弹需现货","开工下滑","难提振","风险原油继续下跌","供需预期仍偏弱",
               "做多螺矿比","不过原油大跌","企稳回升仍需","长期仍有上涨做多","内外比值回升","情绪降温后","供应回升","裂解多头介入","关注疫情控制及需求回暖情况","价格是否下行","中期能否上涨","可做多螺矿比","注意原油反弹","等待回调低位做多利润","FU偏强","油价压力","回调风险逐步降低","积极性回升","下跌主要来自","产能回升的压力",
                "油粕比空单","基差回落","未透露更多鹰派信号","反弹压力下移","等待价格企稳","产量回升","风险在于成本端煤炭价格的下行","基差有所反弹","价差有望走强","乳胶水高位回落","在价格上涨时","基差走弱","比值或将走强","做多短纤与","随着原料下跌",
...
zero = ["震荡对待","上行空间受限","不建议追多","反弹受阻","趋稳运行","做多情绪不强","单边日内交易","基差上涨","不建议参与","价格主要受成本端影响","未见上行驱动","继续跟随油价运行","底部位置的博弈","走势偏震荡","短多暂时离场","维持较为谨慎","下行空间受限","区域震荡","波动风险加大","震荡为主","高位震荡","关注上方压力与下方支撑","盘面震荡","反弹空间有限","反弹幅度已经较高","多TA空EG","价格承压阶段性","价格进入调整阶段",
                ...
                "尚未出现短缺","不建议再追空","建议轻仓操作","需要等待","不建议单边做多","上行驱动较弱","高点很难预估","下行空间或有限","中性为主","维持震荡趋势","震荡思路对待","供求两淡","不建议单边追空","自身主导意愿并不强","高位盘整","高位整理","宽幅波动思路对待",
...
point_7 = ["多头谨慎持有","多头买入机会","偏涨看待","拉涨不锈钢","中长期多头配置","短多交易为主","逢低做多","反弹小周期应未结束","逢低试多","供需偏紧","生产收紧","逢低多","下游补库态度积极","支撑短期价格","缓慢上抬","多单短线持有","支撑铜价",
           "警惕多头逼仓风险","附近的买入机会","多配","推升油价","刺激一波","下行空间料大于","难摆脱低迷走势","明显挤仓",
...
point_5 = ["多单谨慎持有","波段多单","高度可能有限","轻仓逢低做多","高度可能有限","布局长多","反弹力度或有限","中长期看多","酝酿反弹机会","观望或短多","回落可止盈离场","节奏性做多","低点支撑","涨势趋缓","回调接多为主","仍较抗跌","估值修复思路对待","中线轻仓逢低买入","反弹幅度有限","滚动低多","短多长空","下游补库积极","冲高一波后再回落","跟随黄金","回调介入短多","置止损短多","政策面利好","支撑矿价","短期驱动向上",
