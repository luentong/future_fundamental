...
fluc = ["观望", "不宜", "上行承压", "上行乏力", "震荡对待", "先扬后抑", "短期反弹,趋势偏弱", "下行驱动逐渐放缓",
        "反弹难持续", "反套", "上行空间受限", "暂无利好", "高位震荡", "盘面震荡", "反弹空间有限", "多单谨慎持有", "空单谨慎持有",
        ...
        "震荡行情将延续","结构性反弹","中长期多头配置","保持强势运行","谨慎追多","FU偏强","跟随原油为主","震荡思路操作","形成托底","偏空对待","逢高止盈"]
...
def simplify_sent(c):
    ...
    cut_list.reverse()
    for c in cut_list:
        if "才可能企稳回升" in c or "才可能企稳" in c or "议做多裂解价差" in c or "加工差承压" in c or "开工下滑" in c or "难提振" in c or "FU偏强" in c:
                continue
        if "震荡对待" in c or "上行空间受限" in c or "下行空间受限" in c or "波动风险加大" in c \
                ...
                or "高位反复" in c or "空仓" in c or "震荡行情将延续" in c or "跟随原油为主" in c or "震荡思路操作" in c or "逢高止盈" in c:
            return "0"
        ...
        if "下行驱动逐渐放缓" in c or "弱平衡" in c or "不过于追空" in c or "空单谨慎" in c or "谨慎承压" in c or "有回调可能" in c or "压制期价上行" in c or "价格承压" in c \
                or "中期看空" in c or "等待机会做空" in c or "继续回调" in c or "偏空对待" in c:
            return '-0.5'
        if "多单谨慎持有" in c or "低点支撑" in c or "涨势趋缓" in c or "空单止盈" in c or "仍较抗跌" in c or "反弹幅度有限" in c or "短多长空" in \
                ...
                in c or "易涨难跌" in c or "仍偏强" in c or "多单轻仓" in c or "谨慎追多" in c or "形成托底" in c:
            return '0.5'
        if "多头谨慎持有" in c or "偏涨看待" in c or "中长期多头配置" in c:
                return '0.7'
