...
point_5 = ["多单谨慎持有","低点支撑","涨势趋缓","仍较抗跌","反弹幅度有限","短多长空","下游补库积极","冲高一波后再回落","短期获支撑","回落偏多","中枢上移","利润有望继续修复",
                ...
                "易涨难跌","仍偏强","多单轻仓","谨慎追多","形成托底","多单少量参与","支撑盘面","多单滚动操作","一定提振作用","贴水收窄","远月驱动渐显","轻仓试多","可低吸",
...
point_neg_7 = ["回落","存在较强的上行压力","回调","短期压力加剧","偏弱震荡","逢高试空","弱势震荡","跌势为主","维持下跌态势",
               "继续探底","高空","较强上行压力","空单设好止盈","价格偏弱运行"]
point_neg_5 = ["下行驱动逐渐放缓","弱平衡","不过于追空","空单谨慎","谨慎承压","有回调可能","压制期价上行","价格承压",
                "上行空间也较为有限","轻仓做空","重心下移","下调风险","难有趋势性上涨行情","持续性压制","重心或有下移","先抑后扬",
