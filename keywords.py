...
zero = ["震荡对待","上行空间受限","不建议追多","反弹受阻","区间运行","结束反弹离场","趋稳运行","做多情绪不强","单边日内交易","基差上涨","不建议参与","价格主要受成本端影响","未见上行驱动","继续跟随油价运行","底部位置的博弈","走势偏震荡","短多暂时离场","维持较为谨慎","下行空间受限","区域震荡","波动风险加大","震荡为主","高位震荡","关注上方压力与下方支撑","盘面震荡","反弹空间有限","反弹幅度已经较高","多TA空EG","价格承压阶段性","价格进入调整阶段",
                ...
                "谨慎对待","定投方式参与","显现出下跌抵抗","基差出现明显走弱","两难境地","继续调整","继续震荡","下方空间有限","强现实弱" ,"出现反复","盘面看震荡","不具备做多的条件","保持震荡","转为震荡","低多高平","区间交易","处于震荡状态",
...
point_5 = ["多单谨慎持有","中长期操作建议偏多","波段多单","高度可能有限","轻仓逢低做多","高度可能有限","布局长多","反弹力度或有限","中长期看多","酝酿反弹机会","观望或短多","回落可止盈离场","节奏性做多","低点支撑","涨势趋缓","回调接多为主","仍较抗跌","估值修复思路对待","中线轻仓逢低买入","反弹幅度有限","滚动低多","短多长空","下游补库积极","冲高一波后再回落","跟随黄金","回调介入短多","置止损短多","政策面利好","支撑矿价","短期驱动向上",
...
point_neg_7 = ["回落","悲观看待","逢高建仓空单","看空单边","弱势运行","易跌难涨","走势可能趋弱","期价仍被高估","下行过程中波动较大","负反馈进行","反弹后可介入空单","跟随美豆补跌","存在较强的上行压力","反弹布空","反弹后择机做空","空单滚动操作","反弹偏空","反弹后逢高做空","远月逢高空","氛围再度转悲","反弹做空","单建议设置止盈","回调","短期压力加剧","反弹逢高做空","压制近月价格","偏弱震荡","逢高试空","弱势震荡","或将探低","负反馈持续","保持看空",
...
def simplify_sent(c):
    ...
    if "不追空" in c or "不追多" in c:
        return "0"
    if "短线反弹" in c and "短线反弹追涨需谨慎" not in c:
        return "0.7"
    for c in cut_list:
        continued = False
        for i in to_continue:
