...
zero = ["震荡对待","上行空间受限","下行空间受限","波动风险加大","震荡为主","高位震荡","盘面震荡","反弹空间有限","反弹幅度已经较高","多TA空EG",
...
point_7 = ["多头谨慎持有","偏涨看待","中长期多头配置","短多交易为主","逢低做多","逢低试多","供需偏紧","生产收紧","逢低多","下游补库态度积极","支撑短期价格","缓慢上抬",
           "警惕多头逼仓风险","明显挤仓","短期处于上攻","冲高风险","价格受支撑","抬升不锈钢期货价格","持续支撑","维持震荡上扬","参与做多行情","反弹做空"]
point_5 = ["多单谨慎持有","低点支撑","涨势趋缓","仍较抗跌","反弹幅度有限","短多长空","下游补库积极","冲高一波后再回落","跟随黄金","回调介入短多","置止损短多","政策面利好",
           "短期获支撑","回落偏多","中枢上移","利润有望继续修复","短线低吸","回调企稳逢低做多","中期多头配置","回调仍是买入机会","多头信心加强","贴水有收窄预期","震荡略偏强","难有大幅上涨的趋势性行情",
                ...
                "多EG","谨慎追涨","回调幅度有限","不宜追多","短线炒作","支撑尚存","上方空间有限","炒作未止","反弹高度不乐观","逢低布局2209合约多单","回调去布局多单","暂时支撑铜价","小幅反弹",
...
point_3 = ["买近抛远","短空止盈","有支撑","下跌之后反弹","回调空间有限","反弹高度将一般","仍存支撑","上涨持续性仍待观察","有反弹的概率","价格仍存支撑","下跌动能不足","短时超跌反弹","支撑仍在",
            "空单止盈","不宜过度追高","震荡止跌","支撑依然在","逢低多但不要追多","不必过度悲观","不轻言单边做空","继续下跌的空间有限","反弹力度有限",
...
point_neg_7 = ["回落","存在较强的上行压力","回调","短期压力加剧","偏弱震荡","逢高试空","弱势震荡","跌势为主","维持下跌态势","择机布空","震荡偏弱运行","偏弱运行",
               "继续探底","高空","较强上行压力","空单设好止盈","价格偏弱运行","价格仍有一定下行空间","宽幅震荡偏弱"]
point_neg_5 = ["下行驱动逐渐放缓","弱平衡","不过于追空","空单谨慎","谨慎承压","有回调可能","压制期价上行","价格承压","弱于黄金","难有反弹",
