...
zero = ["震荡对待","上行空间受限","下行空间受限","波动风险加大","震荡为主","高位震荡","盘面震荡","反弹空间有限","反弹幅度已经较高",
                ...
                "底部空间或将有限","短期内震荡行情","呈现震荡格局","震荡走势为主","震荡整理","反复震荡","观望","宽幅震荡","走势震荡",
                "宽幅震荡运行","横盘震荡为主","低位宽幅震荡","震荡为主","后期主要关注","仍有反复","跌幅大小","价格跟随原料","基本面变化不大",
                ...
                "横盘整理","延续振荡","延续震荡表现","高位区间震荡","上行驱动不足","维持震荡走势","上行动力不足","区间震荡","做多钢厂利润",
                "仍难打破震荡形态","等待企稳","高抛低吸","短线交易为主","建议暂观望","整体震荡","多单逢高减仓","单边头寸谨慎","不会大跌",
                ...
                "回归整理区间","贵金属波动加大","空单可部分止盈","短线操作为宜","短线交易","震荡走势","跟随油价波动","短线操作","高位宽幅波动",
                "建议观望为主","向上空间或有限","缺乏基本面驱动","宽幅运行","谨慎操作","不建议虚盘操作","短期中性","持币观望","套保压力仍较大",
...
point_5 = ["多单谨慎持有","低点支撑","涨势趋缓","仍较抗跌","反弹幅度有限","短多长空","下游补库积极","冲高一波后再回落","短期获支撑","回落偏多","中枢上移","利润有望继续修复",
                "不宜过分看多","不过于追多","被动涨势","反弹谨慎","反弹偏谨慎","谨慎乐观","多单谨慎","有情绪性买入价值","估值修复的可能","小幅上涨","谨慎反弹",
                "多EG","谨慎追涨","回调幅度有限","不宜追多","短线炒作","支撑尚存","上方空间有限","炒作未止","反弹高度不乐观","逢低布局2209合约多单","回调去布局多单",
                "易涨难跌","仍偏强","多单轻仓","谨慎追多","形成托底","多单少量参与","支撑盘面","多单滚动操作","一定提振作用","贴水收窄","远月驱动渐显",
                "持有前期多单","轻多尝试","反弹强度不及","远月企稳谨慎偏多","回调买入","重心上移","轻仓多单持有","存在支撑","适量买入","逢低短多","轻多跟随","价格持续向上压力也在加大"]
point_3 = ["买近抛远","短空止盈","有支撑","下跌之后反弹","回调空间有限","反弹高度将一般","仍存支撑","上涨持续性仍待观察","有反弹的概率","价格仍存支撑","下跌动能不足",
...
point_neg_7 = ["回落","回调","短期压力加剧","偏弱震荡","逢高试空","弱势震荡","跌势为主","维持下跌态势","继续探底","高空"]
point_neg_5 = ["下行驱动逐渐放缓","弱平衡","不过于追空","空单谨慎","谨慎承压","有回调可能","压制期价上行","价格承压",
                "中期看空","等待机会做空","继续回调","偏空对待","长线偏空","后期仍有压力","反弹抛空","面临调整",
                "上行空间也较为有限","轻仓做空","重心下移","下调风险","难有趋势性上涨行情","持续性压制",
                "空单谨慎持有","不宜过分看跌","限制价格回升","短空长多","谨慎悲观","贴水继续走弱","看空也会偏短暂","轻仓做空远月合约"]
point_neg_3 = ["短多止盈","高位调整压力","上行压力加大","上行动能不足","难有向上驱动","价格稳定偏弱",
                "多单止盈","压制上行空间","多单离场","限制上行高度","限制上方空间","限制其上方空间","现阶段性回调"]
