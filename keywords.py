...
fluc = ["观望", "不宜", "上行承压", "上行乏力", "震荡对待", "先扬后抑", "短期反弹,趋势偏弱", "下行驱动逐渐放缓",
        ...
        "多单离场","逢低试多","定投方式参与","利润向上修复","持续震荡","回调的风险","两难境地","震荡止跌","重心上移","重心下移","供需偏紧","下调风险","较强支撑"]
...
def simplify_sent(c):
    ...
    for c in cut_list:
        ...
        if "震荡对待" in c or "上行空间受限" in c or "下行空间受限" in c or "波动风险加大" in c \
                ...
                or "谨慎对待" in c or "定投方式参与" in c or "两难境地" in c or "继续调整" in c or "下方空间有限" in c or "强现实弱" in c or "出现反复" in c or "盘面看震荡" in c or "区间操作" in c:
            return "0"
